...
public sealed class CorpusMemoryStore : IMemoryStore
{
    ...
    {
        return _store.CreateCollectionAsync(collectionName, cancel);
    }
    ...
    public Task DeleteCollectionAsync(
        ...
        CancellationToken cancel = default)
    {
        return _store.DeleteCollectionAsync(collectionName, cancel);
    }
    ...
    public Task<bool> DoesCollectionExistAsync(
        ...
        CancellationToken cancel = default)
    {
        return _store.DoesCollectionExistAsync(collectionName, cancel);
    }
    ...
    public Task<MemoryRecord?> GetAsync(
        ...
        CancellationToken cancel = default)
    {
        return _store.GetAsync(collectionName, key, withEmbedding, cancel);
    }
    ...
    public IAsyncEnumerable<MemoryRecord> GetBatchAsync(
        ...
        CancellationToken cancel = default)
    {
        return _store.GetBatchAsync(collectionName, keys, withEmbeddings, cancel);
    }

    public IAsyncEnumerable<string> GetCollectionsAsync(CancellationToken cancel = default)
    {
        return _store.GetCollectionsAsync(cancel);
    }
    ...
    public Task<(MemoryRecord, double)?> GetNearestMatchAsync(
        ...
        CancellationToken cancel = default)
    {
        return _store.GetNearestMatchAsync(collectionName, embedding, minRelevanceScore, withEmbedding, cancel);
    }
    ...
    public IAsyncEnumerable<(MemoryRecord, double)> GetNearestMatchesAsync(
        ...
        CancellationToken cancel = default)
    {
        return _store.GetNearestMatchesAsync(collectionName, embedding, limit, minRelevanceScore, withEmbeddings, cancel);
    }
    ...
    public Task RemoveAsync(
        ...
        CancellationToken cancel = default)
    {
        return _store.RemoveAsync(collectionName, key, cancel);
    }
    ...
    public Task RemoveBatchAsync(
        ...
        CancellationToken cancel = default)
    {
        return _store.RemoveBatchAsync(collectionName, keys, cancel);
    }
    ...
    public Task<string> UpsertAsync(
        ...
        CancellationToken cancel = default)
    {
        return _store.UpsertAsync(collectionName, record, cancel);
    }
    ...
    public IAsyncEnumerable<string> UpsertBatchAsync(
        ...
        CancellationToken cancel = default)
    {
        return _store.UpsertBatchAsync(collectionName, records, cancel);
    }
}

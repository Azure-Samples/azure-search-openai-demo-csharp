...
param containerAppsEnvironmentName string = 'cae-lwaqutnfw7yny'

@description('Name of the Azure container registry')
param containerRegistryName string = 'crlwaqutnfw7yny'

@description('Name of the resource group for the Azure container registry')
param containerRegistryResourceGroupName string = 'rg-knipper-ai-docbot-csharp'
...
param formRecognizerResourceGroupName string = 'rg-knipper-ai-docbot-csharp'
...
param searchServiceResourceGroupName string = 'rg-knipper-ai-docbot-csharp'
...
param storageResourceGroupName string = 'rg-knipper-ai-docbot-csharp'
...
var resourceToken = toLower(uniqueString(az.resourceGroup().id, environmentName, location))
...
module containerApps 'core/host/container-apps.bicep' = {
  ...
  params: {
    ...
    containerRegistryResourceGroupName: !empty(containerRegistryResourceGroupName) ? containerRegistryResourceGroupName : resourceGroupName
    location: location
...
output AZURE_FORMRECOGNIZER_RESOURCE_GROUP string = formRecognizerResourceGroupName
output AZURE_FORMRECOGNIZER_SERVICE string = formRecognizer.outputs.name
output AZURE_FORMRECOGNIZER_SERVICE_ENDPOINT string = formRecognizer.outputs.endpoint
output AZURE_COMPUTERVISION_RESOURCE_GROUP string = useVision ? resourceGroupName : ''
...
output AZURE_KEY_VAULT_RESOURCE_GROUP string = resourceGroupName
...
output AZURE_OPENAI_RESOURCE_GROUP string = useAOAI ? resourceGroupName : ''
